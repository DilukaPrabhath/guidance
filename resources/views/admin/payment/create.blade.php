                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <label for="" style="padding-top: 6px;">Rs.40000.00</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <label for="" style="padding-top: 6px;">Rs.20000.00</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-3">
                                        <input type="text" class="form-control" value="0" maxlength="2" aria-label="">
                                        <span class="input-group-append">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Payment History Table</h4>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>2021/01/10</td>
                                <td>
                                    <a href="{{url('admin/payments/old/view')}}" type="button" class="btn btn-dropbox">
